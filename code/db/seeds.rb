...
Technology.create(name: "Perceuse", description: "Améliore grandement le forage", costMoney: 1000, costEnergy: 1000)
Technology.create(name: "Roue à pterodactyle", description: "Permet d'améliorer grandement l'extraction d'énergie en faisant courir des ptérodactyles dans des roues", costMoney: 1000, costEnergy: 5000)
Technology.create(name: "Fourchette à 5 dents", description: "Cette avancée monumentale dans le domaine de la gastronomie vous permet d'améliorer votre lance-fourchette.", costMoney: 5000, costEnergy: 20000)
Technology.create(name: "Modification génétique des poulets", description: "Désormais, les poulets sont munis de dents, ce qui améliore votre canon à poulets", costMoney: 10000, costEnergy: 50000)
Technology.create(name: "Chirurgie esthétique", description: "L'agrandissement des miches de la boulangère permet une meilleure efficacité du boulanger.", costMoney: 80000, costEnergy: 100000)
Technology.create(name: "Peinture rose", description: "Permet de customiser votre bouclier tout en l'impérméabilisant.", costMoney: 1000, costEnergy: 1000)
Technology.create(name: "Aspirateur à méthane", description: "Ce petit outil permet d'extraire une plus grande quantité de méthane directement à la source.", costMoney: 1000, costEnergy: 5000)
Technology.create(name: "Grains de Kopi Luwak", description: "Ce café extrêmement rare satisfera encore mieux vos papilles gustatives.", costMoney: 5000, costEnergy: 80000)
Technology.create(name: "Papier cadeau", description: "Permet de camoufler votre boîte en carton en cadeau. Effet Cheval de Troie garanti !", costMoney: 10000, costEnergy: 5)
Technology.create(name: "Porte-bagages atomique", description: "Permet de ranger vos courses sur votre gyropode.", costMoney: 5000, costEnergy: 8000)
Technology.create(name: "Kit carosserie", description: "Avec ça, vous serez la fierté du bled", costMoney: 10000, costEnergy: 26000)
